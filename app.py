...
NEWS_STYLES = {
    ...
    "📊 ข่าวสถิติ": "เขียนสไตล์ข่าวสถิติ/ตัวเลขฟุตบอล เน้นความ 'แม่นของตัวเลข' เป็นหลัก: ระบุ ใคร-ทำอะไร-กี่ครั้ง/เท่าไหร่-ในกรอบเวลาไหน พร้อมบริบทเปรียบเทียบ (เทียบฤดูกาลก่อน/สถิติร่วม/ทำลายสถิติ/อันดับ) จัดตัวเลขให้อ่านง่ายเป็นข้อ ๆ ห้ามเดาหรือแต่งตัวเลขเอง ถ้าต้นฉบับไม่มีตัวเลขให้เขียนตามที่มีจริงเท่านั้น",
    "📝 แปลบทความ": "เขียนสไตล์บทความยาว/เจาะลึก (long-form) เรียบเรียงเป็นภาษาไทยที่ลื่นไหลอ่านเพลิน คงโครงสร้างและประเด็นครบถ้วน แบ่งย่อหน้าชัดเจน มีการวิเคราะห์/บริบท/เชื่อมโยงเหตุผล ไม่กระชับเกินไปแต่ไม่เยิ่นเย้อ รักษาน้ำเสียงต้นฉบับ (วิเคราะห์/สัมภาษณ์/บทความความเห็น) และแปลให้เป็นธรรมชาติแบบคนไทยเขียน ไม่แปลตรงตัว",
